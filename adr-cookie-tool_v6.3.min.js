/*! Cookie Consent Script - v6.3 Author: Andy Dominique Rak Instagram: https://instagram.com/andydominiquerak */
(function(){
function tryInit(){
  ...
  allowButton.addEventListener("click",()=>{setCookie(COOKIE_NAME,"Allowed",365),setCookie(COOKIE_PERFORMANCE,"Allowed",365),setCookie(COOKIE_PERSONALIZATION,"Allowed",365),setCookie(COOKIE_ADVERTISEMENT,"Allowed",365),slideOutAnimation(()=>{gsap.set(banner,{display:"none"})})});
  ...
  saveButton.addEventListener("click",()=>{const e=saveSwitchStatesToCookies();hideModal(()=>{e||gsap.set(banner,{display:"flex"})})});
